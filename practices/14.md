...
cat <<EOF | sudo tee ~/.claude-code-router/config.json
{
  ...
  "Router": {
    ...
    "think": "openrouter,z-ai/glm-5.1",
    "longContext": "openrouter,z-ai/glm-5.1",
    "longContextThreshold": 60000,
    "webSearch": "openrouter,z-ai/glm-5.1",
    "image": "openrouter,z-ai/glm-5.1"
  },
  "CUSTOM_ROUTER_PATH": ""
}
EOF
...
#export ANTHROPIC_MODEL="openrouter/auto"         # 默认模型   使用ccr则注释此行
...
```json
    ...
    //"claudeCode.selectedModel": "z-ai/glm-4.7", // 使用ccr，则注释此行
```
> 注意：$OPENROUTER_API_KEY 需要到`openrouter.ai`中获取并替换
